...
public class ViewTrips extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        objectCardListArrayList = db.getTrips();
        ...
        cardList.addOnItemTouchListener(
                new RecyclerItemClickListener(this, cardList ,new RecyclerItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, final int position) {
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(ViewTrips.this);
                        ...
                        alert.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                db.remove_trips(Firstline, Secondline);
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        Intent intent= new Intent(ViewTrips.this,MainActivity.class);
