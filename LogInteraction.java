...
public class LogInteraction extends AppCompatActivity implements AdapterView.OnItemSelectedListener{

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_log_interaction);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String PersonName = String.valueOf(personName.getText());
                String Month = String.valueOf(datePicker.getMonth()+1);
                String Day = String.valueOf(datePicker.getDayOfMonth());
                String Year = String.valueOf(datePicker.getYear());
                String Date = Month + "/" + Day + "/" + Year;
                db.insertInteractionIntoTheDatabase(PersonName, Date);
                Toast.makeText(getApplicationContext(),
                        "Saved",
                        Toast.LENGTH_LONG)
                        .show();
                Intent intent= new Intent(LogInteraction.this,MainActivity.class);
                startActivity(intent);
                Log.d("Date",Date);
                Log.d("personName",String.valueOf(personName));
